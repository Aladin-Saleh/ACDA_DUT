...
public class History {
  ...
  public History(javax.swing.JLabel v, String login, String password) {
    ...
    if ((login != null)&&(password != null)) {
      try {
        ...
        try {
          connexion = DriverManager.getConnection("jdbc:mariadb://dwarves.iut-fbleau.fr/"+login,
                                     login, password);
          try {
  ...
  public boolean isQuestionIsPurge(String question)
  {
  ...
  public void purge()
  {
     try
          {
            String query = "DELETE FROM Questions WHERE cle < (SELECT MAX(cle) - 5 FROM Questions)";
